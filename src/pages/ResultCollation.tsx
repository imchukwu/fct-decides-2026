    ...
    <div className="space-y-6">
        ...
        <div className="dashboard-section animate-fade-in">
          ...
          <div className="flex justify-center mt-4">
            <ResponsiveContainer width={250} height={250}>
              <PieChart>
                <Pie data={commencementData} cx="50%" cy="50%" innerRadius={60} outerRadius={100} dataKey="value" strokeWidth={0} animationBegin={200} animationDuration={1000}>
                  {commencementData.map((entry, i) => <Cell key={i} fill={entry.fill} />)}
                </Pie>
              </PieChart>
            </ResponsiveContainer>
          </div>
          <div className="grid grid-cols-2 gap-3 mt-4">
            {commencementData.map((item) => (
      ...
      <div className="dashboard-section animate-fade-in">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={signatureData} barGap={4}>
